                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-icon btn-primary"><i class="fa fa-plus"></i>Tambah Kecamatan</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="float-right">
                        ...
                        <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-icon btn-primary"><i class="fa fa-plus"></i>Tambah Kelurahan</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="float-right">
